...
if __name__ == '__main__':
    ...
    #lithopsgenetics.preprocess_chunk_complete_gzfile(BUCKET_NAME, BUCKET_LINK, os.path.join(LOCAL_TMP, TEST_FILE), '100000')

    # FUNCTION retrieve_random_chunk_gzfile(BUCKET_NAME, BUCKET_LINK, file, start_line, end_line)
    #lithopsgenetics.retrieve_random_chunk_gzfile(BUCKET_NAME, BUCKET_LINK, os.path.join(LOCAL_TMP, TEST_FILE), '101000', '150000')

    # FUNCTION chunk_complete_gzfile(BUCKET_NAME, BUCKET_LINK, file, lines, total_lines)
    #lithopsgenetics.chunk_complete_gzfile(BUCKET_NAME, BUCKET_LINK, os.path.join(LOCAL_TMP, TEST_FILE), '100000', '309956')
